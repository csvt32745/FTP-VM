...
from MaskPropagation.STCNVM.memory_bank import MemoryBank

from STCN.modules import *
from STCN.network import Decoder
...
class STCN(nn.Module):
    ...
    def decode_with_query(self, mem_bank:MemoryBank, qf8, qf4, qk16, qv16): 
