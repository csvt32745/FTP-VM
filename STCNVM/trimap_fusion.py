...
class TrimapGatedFusionBN2(TrimapGatedFusion):
    def __init__(self, ch_feats, ch_mask=1):
        super().__init__(ch_feats, ch_mask)
        del self.gated_convs
        self.gated_convs = nn.ModuleList([
...
class TrimapGatedFusionIN(TrimapGatedFusion):
    def __init__(self, ch_feats, ch_mask=1):
        super().__init__(ch_feats, ch_mask)
        del self.gated_convs
        self.gated_convs = nn.ModuleList([
...
class TrimapGatedFusionGN(TrimapGatedFusion):
    def __init__(self, ch_feats, ch_mask=1):
        super().__init__(ch_feats, ch_mask)
        del self.gated_convs
        self.gated_convs = nn.ModuleList([
